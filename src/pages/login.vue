<template>
  <div>
    <div class="top">
      <!-- <div id="myChart_4" :style="{width: '400px', height: '400px'}"></div>
      <div id="myChart_2" :style="{width: '400px', height: '400px'}"></div>
      <div id="myChart_5" :style="{width: '400px', height: '400px'}"></div>
      <div id="myChart_3" :style="{width: '400px', height: '400px'}"></div>-->
      <div class="t-l">
        <span class="s1">12-28</span>
        <span class="s1">星期五</span>
    ...
    <div class="first-line">
      <div class="first-line-one">
        <p class="p2">今日投放次数</p>
        <p class="p3">28<span class="s5">次</span></p>
      </div>
      <div class="first-line-two">
        <p class="p2">今日投放垃圾总质量</p>
        <p class="p3">93<span class="s5">kg</span></p>
      </div>
...
.p {
  ...
  font-weight: 400;
  color: rgba(0, 0, 0, 1);
  padding: calc(15vh / 10.8) calc(40vw / 19.2) calc(60vw / 19.2) calc(40vw / 19.2);
  box-sizing: border-box;
}
.p1 {
  flex: 1;
